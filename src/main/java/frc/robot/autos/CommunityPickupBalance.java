...
public class CommunityPickupBalance extends SequentialCommandGroup {
  ...
  public CommunityPickupBalance() {
    addCommands(
      ...
      new ParallelRaceGroup(TankDriveSubsystem.get().new driveDistanceCommand(0.3, 0.42, 65), new LoadCube()),
      TankDriveSubsystem.get().new driveDistanceCommand(-0.3, -0.42, 55),
