  ...
  */
  ...
  class setupControls extends CommandBase {
    ...
    private void configureButtonBindings() {
      ...
      Trigger shooter_trigger =  m_driverHID.axisGreaterThan(XboxController.Axis.kLeftTrigger.value, Constants.DEADZONE);
      DoubleSupplier shooter_as_double = () -> m_driverHID.getLeftTriggerAxis();
      CommunityShotCommand shooter_cmd = m_ShooterSubsystem.new CommunityShotCommand(shooter_as_double, m_ShooterSubsystem);
      shooter_trigger.whileTrue(shooter_cmd);
    }
